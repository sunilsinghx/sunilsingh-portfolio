          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
              ...
              <p className="text-gray-400 mb-4">
                A small full-stack app that turns legal document files into
                reusable variable-based templates and generates polished drafts
                through an interactive Q&A flow.
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
                {["FastAPI", "Next.js", "TypeScript", "Docker", "Gemini"].map(
                  (tech, key) => (
                    <span
                      key={key}
                      className="
              ...
              <div className="flex justify-between items-center">
                <a
                  href="https://github.com/sunilsinghx/legal-doc-templater"
            ...
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
              ...
              <div className="flex justify-between items-center">
                <a
                  href="https://github.com/sunilsinghx/chatapp-with-Ollama"
                  className="text-blue-400 hover:text-blue-300 transition-colors my-4"
                >
                  View Project →
                </a>
            ...
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
              ...
              <div className="flex justify-between items-center">
                <a
                  href="https://github.com/sunilsinghx/disaster-response-coordination"
                  className="text-blue-400 hover:text-blue-300 transition-colors my-4"
                >
                  View Project →
                </a>
